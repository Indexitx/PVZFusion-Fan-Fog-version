...
public class Chomper : Plant
{
	...
	protected override void FixedUpdate()
	{
		...
		foreach (Collider2D collider2D in array)
		{
			...
			if (component.theStatus == 1 || component.theStatus == 7 || component.theZombieRow != thePlantRow || component.isMindControlled || component.isFlying)
			{
				continue;
			}
