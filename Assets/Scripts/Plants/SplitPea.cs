...
public class SplitPea : Shooter
{
    ...
    public override GameObject AnimShoot()
	{
        ...
        GameObject obj2 = board.GetComponent<CreateBullet>().SetBullet(theX2, y2, theRow, 0, 10);
        obj.GetComponent<Bullet>().theBulletDamage = 20;
        obj2.GetComponent<Bullet>().theBulletDamage = 20;
    ...
    public GameObject AnimShoot2()
    {
        ...
        float y = position.y;
        int theRow = thePlantRow;
        GameObject obj = board.GetComponent<CreateBullet>().SetBullet(theX, y, theRow, 0, 10);
        obj.GetComponent<Bullet>().theBulletDamage = 20;
        GameAPP.PlaySound(Random.Range(3, 5));
        return obj;
    }
