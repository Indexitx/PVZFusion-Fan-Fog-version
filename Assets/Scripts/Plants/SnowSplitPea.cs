...
public class SnowSplitPea : Shooter
{
    ...
    public override GameObject AnimShoot()
	{
        ...
        GameObject obj2 = board.GetComponent<CreateBullet>().SetBullet(theX2, y2, theRow, 15, 10);
    ...
    public GameObject AnimShoot2()
    {
        ...
        float y = position.y;
        int theRow = thePlantRow;
        GameObject obj = board.GetComponent<CreateBullet>().SetBullet(theX, y, theRow, 15, 10);
