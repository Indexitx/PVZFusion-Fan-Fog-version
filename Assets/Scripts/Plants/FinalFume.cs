	...
	private void AttackZombie()
	{
		...
		foreach (GameObject item in board.zombieArray)
		{
			if (item != null)
			{
				...
				if (component.theZombieRow == thePlantRow && component.shadow.transform.position.x > x && AttackUniqueZombie(component) && !component.isFlying)
				{
