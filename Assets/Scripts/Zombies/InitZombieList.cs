	...
	private static void SetAllowZombieTypeSpawn(int theLevelType, int theLevelNumber)
	{
		if (theLevelType == 0)
		{
			...
			case 30:
				...
				allowZombieTypeSpawn[2] = true;
				allowZombieTypeSpawn[4] = true;
				allowZombieTypeSpawn[24] = true;
                break;
			case 31:
				allowZombieTypeSpawn[0] = true;
				allowZombieTypeSpawn[2] = true;
				allowZombieTypeSpawn[112] = true;
				allowZombieTypeSpawn[25] = true;
				allowZombieTypeSpawn[26] = true;
                break;
			case 32:
				allowZombieTypeSpawn[0] = true;
				allowZombieTypeSpawn[2] = true;
				...
				allowZombieTypeSpawn[24] = true;
				allowZombieTypeSpawn[112] = true;
				allowZombieTypeSpawn[114] = true;
				break;
			case 33:
				allowZombieTypeSpawn[0] = true;
				allowZombieTypeSpawn[113] = true;
				allowZombieTypeSpawn[204] = true;
				allowZombieTypeSpawn[25] = true;
				allowZombieTypeSpawn[26] = true;
                break;
			case 34:
